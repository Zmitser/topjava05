...
public class MealTestData {
    ...
    public static final List<UserMealWithExceed> USER_MEALS_WITH_EXCEED = UserMealsUtil.getWithExceeded(Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1), LoggedUser.getCaloriesPerDay());
    public static final List<UserMealWithExceed> USER_MEALS_WITH_EXCEED_BETWEEN = UserMealsUtil.getWithExceeded(Arrays.asList(MEAL3, MEAL2, MEAL1), LoggedUser.getCaloriesPerDay());
