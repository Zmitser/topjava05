...
public class UserMealRestControllerTest extends AbstractControllerTest {
    ...
    public void testGetAll() throws Exception {
        mockMvc.perform(get(REST_URL)
                ...
                .andDo(print())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(UserMealsUtil.getWithExceeded(USER_MEALS, UserUtil.DEFAULT_CALORIES_PER_DAY)));
    }
    ...
    public void testFilterAll() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?startDate=&endTime=")
                ...
                .andDo(print())
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(
                        UserMealsUtil.getWithExceeded(Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1), UserUtil.DEFAULT_CALORIES_PER_DAY)));
    }
}